...
namespace Blocto.Sdk.Evm.Utility
{
    public class EthConvert
    {
        ...
        {
            if (FormattingExtensions.ToStringInvariant(ethUnit).Trim('0') == "1") return true;
        ...
        {
            return FormattingExtensions.ToStringInvariant(unitValue).Length - 1;
        }
